...
public class HylaFAXPooledClient extends HylaFAXClient implements PooledClient, Runnable {
    ...
    private static final Log log = LogFactory.getLog(HylaFAXPooledClient.class);
     ...
     */
    public void open(String host, int newPort) throws UnknownHostException, IOException, ServerResponseException {
     ...
     * @throws ServerResponseException
     */
    void poolOpen(String host, int newPort) throws UnknownHostException, IOException, ServerResponseException {
